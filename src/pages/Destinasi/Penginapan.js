...
const TablePenginapan = () => {
    const data = [
        { name: 'Aston Madiun Hotel', desa_wisata: 'Desa Wisata Kare', status_wisata: 'Pribadi', pengelola: 'Haasstt', npwp: null, status_verifikasi: 'Verified', statusclassName: 'badge badge-success' },
        { name: 'Aston Madiun Hotel', desa_wisata: 'Desa Wisata Kare', status_wisata: 'Pribadi', pengelola: 'Haasstt', npwp: null, status_verifikasi: 'Verified', statusclassName: 'badge badge-success' },
        { name: 'Aston Madiun Hotel', desa_wisata: 'Desa Wisata Kare', status_wisata: 'Pribadi', pengelola: 'Haasstt', npwp: null, status_verifikasi: 'Verified', statusclassName: 'badge badge-success' },
        { name: 'Aston Madiun Hotel', desa_wisata: 'Desa Wisata Kare', status_wisata: 'Pribadi', pengelola: 'Haasstt', npwp: null, status_verifikasi: 'Verified', statusclassName: 'badge badge-success' },
        { name: 'Aston Madiun Hotel', desa_wisata: 'Desa Wisata Kare', status_wisata: 'Pribadi', pengelola: 'Haasstt', npwp: null, status_verifikasi: 'Verified', statusclassName: 'badge badge-success' },
                    ...
                    <div className="col-lg-12 grid-margin stretch-card">
                        <div className="card">
                            <div className="card-body">
                                ...
                                {/* <h4 className="card-title">Tabel Industri Penginapan</h4>
